          ...
          <div class="container">
            ...
            <div class="col-md-8">
              <div class="location-details  p-0 d-md-none">
                <span class="rating d-flex align-items-center"><i class="fa fa-star"></i>4.5 <small class="ml-2">Overall Ratings</small></span>
              </div>
              <h2 class="ride-heading mt-lg-5 pt-lg-3 mt-2">
                ...
                <div class="mob-rider-profile d-flex align-items-center mt-4 d-md-none">
                  ...
                  <div class="ml-auto"><button class="follow-btn w-100 " tabindex="0"><i class="fa fa-plus mr-2"></i>FOLLOW</button></div>
                </div>
                  ...
                  <div class="col-md-8 ">
                    <div class="byker-profile-rate d-flex align-items-center justify-content-between">
                      <span class="rating border-right py-2 px-3 d-flex align-items-center justify-content-center w-33">
                        ...
                        <span>
                          <span class="rider-star"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-half"></i> </span>
                        ...
                        <span class="w-33 d-flex align-items-center px-3 h-100 border-right justify-content-center">
                          <span class="star-txt"><i class="fa fa-star"></i> 4.5</span> 
              ...
              <div class="card ml-4">
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center mt-3">
                    <div class="col-md-8">
                      <button class="follow-btn w-100 mt-2" tabindex="0"><i class="fa fa-plus mr-2"></i>FOLLOW</button>
                    </div>
               ...
               <div class="col-md-8">
                 <div class="cust-left-block  pt-4">
                   ...
                   <div class="rider-overview mt-3 mt-lg-0">
                    Bangalore is an energetic city full of passionate young crowd, mostly IT folks like me. I got my first job soon after 
                    graduation and the working location turned out to be this awesome city with perfect weather. the city of of 
                    Gardens n Lakes but I would prefer The City of Beer. This is the place where I was introduced to this addiction 
                    of motorcycle touring. After spending almost 3 years It was time for me to change the job and head back North 
                    to my hometown, the Capital city New Delhi. After months of searching I finally got the offer for a job in Delhi. <br><a href="#" class="mt-2 font-weight-bold d-inline-block">Read more</a>
                   </div>
                        ...
                        <li>
                          <div class="row">
                                ...
                                <div class="d-none d-md-block">
                                  ...
                                  <div class="d-flex mt-3">
                                    ...
                                    <div class="pl-2">
                                      ...
                                      <p class="timeline-keypoint">Hotel Marvanthe, Karnataka, India <a target="_blank" href="https://www.google.com/maps/search/?api=1&query={{urlencode($rideDay['end_location'])}}" class="ml-1 font-weight-bold">View on Map</a></p>
                                    </div>
                                  </div>
                            ...
                            <div class="col-3 text-right">
                              <img src="{{ asset('public/images/rides/')}}/{{$ride_images[0]}}" class="img-fluid timeline-img"><small class="no-of-imgs">
...
<br><a href="#" class="mt-2 font-weight-bold d-inline-block">Read more</a>
                   ...
                   <div class="col-12 mb-3">
                     <div class="rides-block d-none d-md-flex">
                       <div class="rider-img-block mr-md-3 ml-3 ml-md-0 order-2 order-md-1">
                         <img src="{{ asset('public/images/rides/')}}/{{$rides['ride_image']}}" class="img-fluid">
                       </div>
               ...
               <div class="col-md-4 d-none d-md-block ">
                 <div class="right-block pt-4">
                   <button class="post-btn w-100 mb-3">ASK QUESTIONS ?<small>LOGIN REQUIRED</small></button>
                   <div class="card mt-2 mb-3 border-0"  >
                    <ul class="list-group list-group-flush cust-notify">
                      <li class="list-group-item"><h4 class="notify-heading">Updates</h4></li>
