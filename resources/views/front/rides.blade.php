        ...
        <div class="row">
            <div class="col-md-4 d-none d-md-block">
                <div class="right-block pt-5">
                    <div class="left-filters-block">
                        <form action="" id="rideFilterForm">
                            <div class="d-flex align-items-center left-filters mb-4">
                                <span class="refine-heading">Refine your results</span>
                                <span class="ml-auto "><a href="javascript:void(0)" onclick="resetRideFilterForm()" class="reset-btn">Reset All</a></span>
                            </div>
                            ...
                            <div class="input-field">
                                <input type="text" autocomplete="off" name="month" id="month" class="input-block  bg-white" placeholder="  " value="">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordian-block">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        ...
                                        <div class="custom-control custom-checkbox mb-2 mt-3">
                                            <input class="custom-control-input" type="checkbox" value="Local" name="ride_type" checked>
                                            <label class="custom-control-label" for="Local">
                                                Local Rides (Within a place)
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" value="station" name="ride_type">
                                            <label class="custom-control-label" for="station">
                                                Out of station
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="accordian-block">
                                    <div id="headingTwo" class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>
                                    </div>
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="rating-block d-flex align-items-center mt-3">
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('ride_rating', 1)">
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('ride_rating', 3)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('ride_rating', 5)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                ...
                                <div class="accordian-block">
                                    <div id="headingThree" class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"></a>
                                    </div>
                                ...
                                <div class="accordian-block">
                                    <div id="headingFour" class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"></a>
                                    </div>
                                ...
                                <hr class="full-h-line ml-0 my-4">
                                <div class="accordian-block">
                                    <div id="headingFive" class="d-flex align-items-center">
                                        <h2 class="mb-0">
                                            Road Quality
                                        </h2>
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive"></a>
                                    </div>
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                        <div class="rating-block d-flex align-items-center mt-3">
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_quality', 1);">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">1+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_quality', 3)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">3+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_quality', 5);">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">5</span>
                                            </a>
                                ...
                                <hr class="full-h-line ml-0 my-4">
                                <div class="accordian-block">
                                    <div id="headingSix" class="d-flex align-items-center">
                                        <h2 class="mb-0">
                                            Scenery
                                        </h2>
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix"></a>
                                    </div>
                                    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                                        <div class="rating-block d-flex align-items-center mt-3">
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_scenic', 1)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">1+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_scenic', 3)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">3+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('road_scenic', 5)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">5</span>
                                            </a>
                                        </div>
                                ...
                                <hr class="full-h-line ml-0 my-4">
                                <div class="accordian-block">
                                    <div id="headingSeven" class="d-flex align-items-center">
                                        <h2 class="mb-0">
                                            Biker Rating
                                        </h2>
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven"></a>
                                    </div>
                                    <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                                        <div class="rating-block d-flex align-items-center mt-3">
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('rider_rating', 1)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">1+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('rider_rating', 3)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">3+</span>
                                            </a>
                                            ...
                                            <a class="star-rating" href="javascript:void(0)" onclick="filterRide('rider_rating', 5)">
                                                <span class="star-icon"><i class="fa fa-star"></i></span>
                                                <span class="rate-num">5</span>
                                            </a>
                                        </div>
                                ...
                                <hr class="full-h-line ml-0 my-4">
                                <div class="accordian-block">
                                    <div id="headingEight" class="d-flex align-items-center">
                                        <h2 class="mb-0">
                                            Posted by
                                        </h2>
                                        <a href="javascript:;" class="plus-icon" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight"></a>
                                    </div>
            ...
            <div class="col-md-8" id="filtered_ride_data">
                <div class="cust-left-block pt-5">
                    ...
                    Rides between Bengaluru and Delhi
                   </h2> -->
                    <div class="d-flex align-items-center filter-details mb-4">
                        <!-- <span class="filter-block1">45 Results </strong></span> -->
                    ...
                    <div class="row">
                        ...
                        @if($key < 2) <div class="col-12 mb-3">
                            <div class="rides-block d-none d-md-flex">
                                ...
                                <div class="rider-details-block w-100 order-1 order-md-2">
                                    ...
                                    <div class="location-details d-flex align-items-center">
                                        ...
                                        <span class="other-details"><i class="fa fa-calendar-o"></i>{{$ride['no_of_days']}} <small>Days trip</small></span>
...
<script>
    function resetRideFilterForm() {
        document.getElementById('rideFilterForm').reset();
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            url: "{{route('ride-filter-search')}}",
            type: "POST",
            data: $('#rideFilterForm').serialize(),
            success: function(response) {
                $('#filtered_ride_data').html(response);
            }
        });

    }

    function filterRide(search_key, search_val) {
        $('#' + search_key).val(search_val);
        getFilterData();
    ...
    $(document).ready(function() {
        ...
        $('.star-rating').on('click', function() {
            $(this).addClass('active-rating').siblings().removeClass('active-rating');
        });
