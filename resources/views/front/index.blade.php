			...
			<div class="col-md-8">
				<div class="cust-left-block pt-4">
					...
					<div class="other-cities slider border-bottom pb-5 mb-2">
						...
						<div class="slide">
							<img src="{{ asset('public/images/rides/')}}/{{isset($explore_ride[1]['image']) ? $explore_ride[1]['image'] : 'not_found.png'}} ">
							...
							<div class="top-riders-block">
								<div class="card">
									...
									<div class="card-body position-relative">
										...
										<button class="follow-btn w-100 mt-2 follow-rider-{{$rider['id']}}" onclick="followRider('<?= $rider['id'] ?>')" @if($rider['is_rider_owner']==true) disabled @endif>
											<i class="fa fa-plus mr-2"></i>Follow
										</button>
										@else
										<button class="follow-btn w-100 mt-2 un-follow-rider-{{$rider['id']}}" onclick="unFollowRider('<?= $rider['id'] ?>')">
									...
									<div class="card-body position-relative">
										...
										<div class="d-flex">
											...
											<button class="join-btn flex-grow-1 mt-2 mr-1 leave-group-{{$group['group_owner_id']}}" onclick="leaveGroup(<?=$group['group_owner_id']?>)">
												<i class="fa fa-minus mr-2"></i>Cancel
											</button>
											@endif
											...
											<i class="fa fa-plus mr-2"></i>UNFOLLOW</button>
											@endif
										</div>
					...
					<div class="events-details slider border-bottom pb-5 mt-4 mb-2">
						...
						<div class="slide">
							<img src="{{ asset('public/images/rides/')}}/{{isset($event['ride_image']['image']) ? $event['ride_image']['image'] : 'not_found.png'}}">
							<div class="img-content">
					...
					<div class="row  mb-3 pb-3">
						...
						<div class="col-12 mb-3">
							<div class="rides-block d-none d-md-flex">
								<div class="rider-img-block mr-md-3 ml-3 ml-md-0 order-2 order-md-1">
									<img src="{{ asset('public/images/rides/')}}/{{isset($event['ride_image']['image']) ? $event['ride_image']['image'] : 'not_found.png'}}" class="img-fluid">
								</div>
								<div class="rider-details-block w-100 order-1 order-md-2">
									<div class="location-heading-block ">
										<div>
					...
					<div class="row">
						...
						<div class="col-12 mb-3">
							<div class="rides-block d-none d-md-flex">
								<div class="rider-img-block mr-md-3 ml-3 ml-md-0 order-2 order-md-1">
									<img src="{{ asset('public/images/rides/')}}/{{isset($event['ride_image']['image']) ? $event['ride_image']['image'] : 'not_founf.png' }}" class="img-fluid">
								</div>
								<div class="rider-details-block w-100 order-1 order-md-2">
									<div class="location-heading-block ">
										<div>
							...
							<div class="rides-block flex-column d-md-none">
								<div class="d-flex">
									...
									<div class="rider-img-block ml-3 ">
										<img src="{{ asset('public/images/groups/events/')}}/{{isset($event['ride_image']['image']) ? $event['ride_image']['image'] : 'not_founf.png'}}" class="img-fluid">
									</div>
								</div>
								<div class="d-flex align-items-center mt-1">
									<div class="userdetails d-flex align-items-center">
