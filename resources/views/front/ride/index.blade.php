		...
		<div class="col-md-8">
		  ...
		  <div class="cust-left-block">				
				...
				<div class="d-flex align-items-center mt-4 mb-2">
					...
					<span class="ml-auto filter-block3 mob-filter"><a href="{{route('my-rides.create')}}" class="post-btn lg px-5">ADD NEW RIDE</a></span>
			...
			@if(count($rides) > 0)
				...
				<div class="rides-block d-none d-md-flex">
					...
					<div class="location-details justify-content-start d-flex align-items-center">
					...
					<div>
						@if(!empty($ride['description']))
							<small class="sml-txt font-italic mb-2 d-block">Review Highlight</small>
							<div class="byke-details">{{substr($ride['description'], 0, 200)}}.. </div>
						 @endif
