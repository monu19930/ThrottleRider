  ...
  <div class="row">
      @include('layouts.adminLayout.admin-sidebar')
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">        
            <h4>Ride Details</h4>
            <div class="row mt-5">
                <strong><a href="{{route('admin.rides')}}" class="href"><< Back</a></strong>
                <div class="col-md-12 mt-2">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <button class="btn btn-primary" id="change_status" type="3" content="{{$rides->status}}" onclick="changeStatus('{{$rides->id}}')"><i class="fa fa-eye"></i>Change Status</button>
                        </div>
                    </div>              
                </div>
            </div>
